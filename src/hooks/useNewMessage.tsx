...
export function useNewMessage({message, conversationId, authorId, clearInput}:useMessageArguments):useMessageReturnType
{
    const [messages, setMessages]= useState<Message[]>([])
    const post = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
